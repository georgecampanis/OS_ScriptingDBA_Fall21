...
$Sta = New-ScheduledTaskAction -Execute "C:\Windows\System32\WindowsPowerShell\v1.0\powershell.exe" –Argument '-ExecutionPolicy Bypass -Command "C:\Users\Student\Desktop\powershell\passingpara.ps1 -firstname George -lastname Campanis; exit $LASTEXITCODE"'
